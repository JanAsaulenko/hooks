...
const Authentication = (props) => {
    ...
    useEffect(() => {
        ...
        setCurrentUserState(state => ({
            ...state, isLoggedin: true, isLoading: false,
                            ...
                            <fieldset className="form-group">
                                {
                                    !isLogin && (
                                        <fieldset className="form-group">
                                            <input type="text" className="form-control form-control-lg" placeholder="Username" value={username} onChange={data => setUserName(data.target.value)} />
                                        </fieldset>
                                    )
                                }

                                <fieldset className="form-group">
                                    <input type="email" className="form-control form-control-lg" placeholder="Email" onChange={e => setEmail(e.target.value)} value={email} />
                                ...
                                <button disabled={isLoading} className="btn btn-lg btn-primary pull-xs-right">{pageTitle}</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
