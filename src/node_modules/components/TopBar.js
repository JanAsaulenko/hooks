                    ...
                    <ul className="nav navbar-nav pull-xs-right">
                        { state.isLoggedIn === false && (
                            <>
                                ...
                                <li className="nav-item"> <NavLink to='/signup' className="nav-link">Register</NavLink></li>
                            </>
                        )
                        }
                        { state.isLoggedIn === true && (
                            <>
                                ...
                                <li className="nav-item">
                                    <NavLink to={ `profiles/${ state.currentUser.user.username }` } className="nav-link">
                                        <img src={ state.currentUser.user.image ? state.currentUser.user.image : "logo192.png" } className="user-pic" alt="" />
                                        &nbsp;
